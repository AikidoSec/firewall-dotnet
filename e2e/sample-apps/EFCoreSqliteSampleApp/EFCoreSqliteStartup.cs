...
using EFCoreSqliteSampleApp.Controllers;
...
{
    /// <summary>
    /// EF Core SQLite-specific implementation of the base startup class
    /// </summary>
    public class EFCoreSqliteStartup : BaseStartup
    {
        private readonly DatabaseService _databaseService;
        private readonly EFCoreSqlitePetsController _petsController;
        ...
        public EFCoreSqliteStartup()
        {
            ...
            _petsController = new EFCoreSqlitePetsController(_databaseService);
        }
