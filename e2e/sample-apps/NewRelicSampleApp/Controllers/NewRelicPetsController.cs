...
namespace NewRelicSampleApp.Controllers;

public class NewRelicPetsController : BasePetsController
{
    ...
    public NewRelicPetsController(DatabaseService databaseService)
    {
